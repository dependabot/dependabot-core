...
# See also Dependabot::Gradle::UpdateChecker::VersionFinder, which this
# UpdateChecker is adapted from.
module Dependabot
  module Sbt
    class UpdateChecker
      class VersionFinder
        ...
        def filter_ignored_versions(possible_versions)
          ...
          ignored_versions.each do |req|
            ignore_req = Sbt::Requirement.new(req.split(","))
            versions_array =
              versions_array.
        ...
        def dependency_metadata(repository_url)
          ...
          @dependency_metadata[repository_url] ||=
            begin
              ...
              namespace = Sbt::FileParser::RepositoriesFinder
        ...
        def dependency_repository_urls
          ...
          @dependency_repository_urls ||=
            requirement_files.flat_map do |target_file|
              Sbt::FileParser::RepositoriesFinder.new(
                dependency_files: dependency_files,
