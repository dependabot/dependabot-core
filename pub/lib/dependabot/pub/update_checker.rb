...
module Dependabot
  module Pub
    class UpdateChecker < Dependabot::UpdateCheckers::Base
      ...
      def latest_version
        version = version_unless_ignored(version_report.latest_version, current_version: dependency.version)
      ...
      def updated_requirements
        ...
        entry = if vulnerable?
                  ...
                  version_report.latest_resolvable_version
                end
        return [] unless entry
      ...
      def latest_version_resolvable_with_full_unlock?
        entry = version_report.latest_version_resolvable_with_full_unlock.find { |d| d["name"] == dependency.name }
      ...
      def updated_dependencies_after_full_unlock
        report_section = if vulnerable?
                           ...
                           version_report.latest_version_resolvable_with_full_unlock
                         end
      ...
      def version_report
        return @version_report if @version_report
