  ...
  module Docker
    class Tag
      ...
      def comparable_to?(other)
        ...
        # Dated and non-dated versions are not comparable — prevents
        # updating from 4.8-windowsservercore-ltsc2022 to 4.8-20250909-windowsservercore-ltsc2022
      ...
      def numeric_version
        ...
        # Strip date components from the version so they don't inflate semver
        # comparison. "4.8-20250909" should compare as "4.8", not "4.8.20250909".
        # The date is metadata — actual recency is determined by timestamps.
        result&.gsub(/-\d{8}(?:\b|$)/, "")
      end
