  ...
  module Docker
    ...
    class UpdateChecker < Dependabot::UpdateCheckers::Base
      ...
      def get_tag_publication_details(tag)
        ...
        # Some registries (e.g. lscr.io) deny access to the endpoints used for
        # cooldown verification. Treat this as "unknown publication date" rather
        # than failing the entire update job.
