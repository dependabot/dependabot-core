module Functions
  class LockfileUpdater
    ...
    def initialize(gemfile_name:, lockfile_name:, dir:, credentials:,
                  dependencies:)
    ...
    attr_reader :gemfile_name, :lockfile_name, :dir, :credentials,
                :dependencies
    ...
    def set_bundler_flags_and_credentials
      ...
      # Force bundler to use https when fetching github GIT sources
    ...
    def using_bundler_2?
      ...
      lockfile.match?(/BUNDLED WITH\s+2/m)
    end
  end
end
