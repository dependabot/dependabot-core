    ...
    class UpdateChecker
      class VersionResolver
        ...
        def initialize(dependency:, unprepared_dependency_files:,
                       repo_path: nil, credentials:, ignored_versions:,
        ...
        attr_reader :dependency, :unprepared_dependency_files, :repo_path,
                    :credentials, :ignored_versions, :replacement_git_pin,
