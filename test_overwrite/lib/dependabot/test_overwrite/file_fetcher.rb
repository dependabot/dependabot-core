  ...
  module TestOverwrite
    class FileFetcher < Dependabot::FileFetchers::Base
      ...
      def fetch_files
        ...
        unless allow_beta_ecosystems?
          raise Dependabot::DependencyFileNotFound.new(
            nil,
            "TestOverwrite is currently in beta. Please contact Dependabot support to enable it."
          )
        end
      ...
      def ecosystem_versions
        ...
        # Example: { package_managers: { "test_overwrite" => "1.0.0" } }
        nil
      end
    end
  end
...
Dependabot::FileFetchers.register("test_overwrite", Dependabot::TestOverwrite::FileFetcher)
