...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-test_overwrite"
  spec.summary      = "Provides Dependabot support for TestOverwrite"
  spec.description  = "Dependabot-TestOverwrite provides support for bumping TestOverwrite dependencies via Dependabot. " \
