  ...
  module Cargo
    class UpdateChecker < Dependabot::UpdateCheckers::Base
      ...
      def latest_git_tag_is_resolvable?
        ...
        return false if git_commit_checker.local_tag_for_latest_version_respecting_cooldown(update_cooldown).nil?

        replacement_tag = T.must(git_commit_checker.local_tag_for_latest_version_respecting_cooldown(update_cooldown))
      ...
      def updated_source
        ...
        if git_commit_checker.pinned_ref_looks_like_version? &&
           latest_git_tag_is_resolvable?
          new_tag = T.must(git_commit_checker.local_tag_for_latest_version_respecting_cooldown(update_cooldown))
