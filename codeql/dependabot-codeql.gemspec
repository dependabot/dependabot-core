...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-codeql"
  spec.summary      = "Provides Dependabot support for CodeQL packs"
  spec.description  = "Dependabot-CodeQL provides support for bumping CodeQL query pack dependencies via Dependabot. " \
