...
[dependabot-core-dev] ~ $ cd updater/
[dependabot-core-dev] ~/updater $ bundle
```
...
```zsh
[dependabot-core-dev] ~/updater $ bundle exec rspec
```

You can run an individual test file like so:

```zsh
[dependabot-core-dev] ~/updater $ bundle exec rspec spec/dependabot/integration_spec.rb
```
...
```zsh
[dependabot-core-dev] ~/updater $ VCR=new_episodes bundle exec rspec
```
