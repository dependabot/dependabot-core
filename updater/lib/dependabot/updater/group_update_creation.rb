    ...
    module GroupUpdateCreation
      ...
      def update_checker_for(dependency, dependency_files, group, raise_on_ignored:)
        Dependabot::UpdateCheckers.for_package_manager(job.package_manager).new(
          ...
          repo_contents_path: job.repo_contents_path,
          credentials: job.credentials,
          ignored_versions: ignored_versions_for(dependency, group),
      ...
      def ignored_versions_for(dependency, group)
        ...
        versions_ignored_from_group = group.ignored_versions_for(dependency)
