...
final class Updater
{
     ...
     */
    public static function require(array $args): array
    {
        ...
        // Check if $dependencyVersion is provided and set require accordingly
        $dependencyVersionRequirement = isset($dependencyVersion) && $dependencyVersion !== ''
        ...
        // For all potential options, see RequireCommand in composer
        $install
            ->setWriteLock(true)
            ->setUpdate(false)
            ->setInstall(true)
            ->setDevMode(true)
            ->setRequire($dependencyVersionRequirement)
            ->setOnlyAllowSpecifiedPackages(false)
