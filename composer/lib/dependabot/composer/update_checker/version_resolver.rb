  ...
  module Composer
    class UpdateChecker
      class VersionResolver # rubocop:disable Metrics/ClassLength
        ...
        # Example Timeout error: "curl error 28 while downloading https://example.com:81/packages.json: Failed to connect to example.com port 81 after 9853 ms: Connection timed out"
        SOURCE_TIMED_OUT_REGEX = /.*curl error 28 while downloading (?<url>https?:\/\/.+\/packages\.json): /
