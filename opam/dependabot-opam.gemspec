...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-opam"
  spec.summary      = "Provides Dependabot support for OCaml opam"
  spec.description  = "Dependabot-Opam provides support for bumping OCaml opam dependencies via " \
