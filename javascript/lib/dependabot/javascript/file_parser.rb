...
module Dependabot
  module Javascript
    class FileParser < Dependabot::FileParsers::Base
      ...
      sig { abstract.returns(LockfileParser) }
      ...
      sig { abstract.returns(T.class_of(Dependabot::Javascript::Version)) }
      def version_class; end

      sig { abstract.returns(T.class_of(Dependabot::Javascript::Requirement)) }
