...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-opentofu"
  spec.summary      = "Provides Dependabot support for OpenTofu"
  spec.description  = "Dependabot-OpenTofu provides support for bumping OpenTofu modules via Dependabot. " \
