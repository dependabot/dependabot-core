...
require "dependabot/bun/update_checker/latest_version_finder"
...
RSpec.describe Dependabot::Bun::UpdateChecker::PackageLatestVersionFinder do
    ...
    context "when dealing with a dependency hosted on another registry" do
      ...
      context "when the request times out" do
        ...
        context "when dealing with a git dependency" do
          before do
            allow_any_instance_of(Dependabot::Bun::Package::PackageDetailsFetcher) # rubocop:disable RSpec/AnyInstance
      ...
      context "with credentials" do
        ...
        context "when the latest version has been yanked" do
          ...
          it { is_expected.to eq(Dependabot::Bun::Version.new("1.8.0")) }
        end
  ...
  describe "#possible_versions" do
    ...
    it "returns a list of versions" do
      expect(possible_versions).to eq(
        [
          Dependabot::Bun::Version.new("1.7.0"),
          Dependabot::Bun::Version.new("1.6.0"),
          Dependabot::Bun::Version.new("1.5.1"),
          Dependabot::Bun::Version.new("1.5.0"),
          Dependabot::Bun::Version.new("1.4.0"),
          Dependabot::Bun::Version.new("1.3.1"),
          Dependabot::Bun::Version.new("1.3.0"),
          Dependabot::Bun::Version.new("1.2.1"),
          Dependabot::Bun::Version.new("1.2.0"),
          Dependabot::Bun::Version.new("1.1.0"),
          Dependabot::Bun::Version.new("1.0.1"),
    ...
    context "with ignored versions" do
      ...
      it "excludes ignored versions" do
        ...
        expect(latest_version)
          .to eq(Dependabot::Bun::Version.new("15.6.2"))
      end
    end
  ...
  describe "#possible_previous_versions_with_details" do
    ...
    context "with ignored versions and non pre-release version requirement" do
      ...
      it "includes ignored versions and excludes pre-releases" do
        ...
        expect(latest_version)
          .to eq(Dependabot::Bun::Version.new("16.6.0"))
      end
    end
