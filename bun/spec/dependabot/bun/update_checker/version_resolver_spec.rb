          ...
          expect(resolver.dependency_updates_from_full_unlock)
            .to contain_exactly({
              dependency: Dependabot::Dependency.new(
                name: "vue",
                version: Dependabot::Bun::Version.new("2.5.20"),
                package_manager: "bun",
                requirements: [{
                  file: "package.json",
                  requirement: "2.5.20",
              ...
              version: Dependabot::Bun::Version.new("2.5.21"),
      ...
      it "gets the right list of dependencies to update" do
        expect(resolver.dependency_updates_from_full_unlock)
          .to contain_exactly({
            ...
            version: Dependabot::Bun::Version.new("16.3.1"),
            ...
            version: Dependabot::Bun::Version.new("16.6.0"),
            previous_version: "15.2.0"
          })
      end
    end
