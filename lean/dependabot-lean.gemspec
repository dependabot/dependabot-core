...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-lean"
  spec.summary      = "Provides Dependabot support for Lean 4 toolchain"
  spec.description  = "Dependabot-lean provides support for managing Lean 4 " \
                      "toolchain versions via the lean-toolchain file."
