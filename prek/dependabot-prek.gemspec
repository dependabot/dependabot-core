...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-prek"
  spec.summary      = "Provides Dependabot support for prek"
  spec.description  = "Dependabot-prek provides support for bumping prek dependencies via Dependabot. " \
