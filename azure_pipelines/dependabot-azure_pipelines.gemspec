...
Gem::Specification.new do |spec|
  ...
  spec.summary      = "Provides Dependabot support for Azure Pipelines"
  spec.description  = "dependabot-azure_pipelines provides support for bumping Azure Pipelines task versions via " \
                      "Dependabot. If you want support for multiple package managers, you probably want the " \
