    ...
    class FileUpdater < Dependabot::FileUpdaters::Base
      ...
      def evaluate_properties(string, buildfile)
        ...
        string.scan(Gradle::FileParser::PROPERTY_REGEX) do
          ...
          property_value = T.let(property_value_finder.property_value(
      ...
      def property_value_finder
        ...
        @property_value_finder ||= Gradle::FileParser::PropertyValueFinder
