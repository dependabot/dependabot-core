...
RSpec.describe Dependabot::Gradle::Version do
  ...
  describe "#<=>" do
    ...
    context "when compared to a Gradle::Version" do
      context "when that is lower" do
      ...
      describe "from the spec" do
        ...
        context "with numeric token after underscore" do
        ...
        context "with dynamic minor version" do
          let(:version) { described_class.new("1.+") }
        ...
        context "with dynamic patch version" do
          let(:version) { described_class.new("1.1.+") }
