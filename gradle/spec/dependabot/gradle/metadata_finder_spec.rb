...
RSpec.describe Dependabot::Gradle::MetadataFinder do
  ...
  describe "#source_url" do
    ...
    context "when there is no github link in the pom" do
      ...
      context "when it is in the parent" do
        before do
        ...
        context "when that doesn't match the name of the artifact" do
          ...
          context "when it doesn't have a subdirectory with its name" do
            let(:repo_contents_fixture_nm) { "contents_js_npm.json" }

            it { is_expected.to be_nil }
          end

          context "when it have a subdirectory with its name" do
    ...
    context "when using a custom registry" do
      ...
      context "with credentials" do
        ...
        context "when it includes a username and password" do
          let(:credentials) do
            [
              {
                "type" => "git_source",
