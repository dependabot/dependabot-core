...
RSpec.describe Dependabot::FileParsers::Elm::ElmPackage do
  ...
  let(:elm_package_fixture_name) { "less_than_or_equals" }
  ...
  describe "parse" do
    ...
    context "with <=" do
      ...
      describe "the last dependency" do
        ...
        it "has the right details" do
          ...
          expect(dependency.name).to eq("Fresheyeball/elm-tuple-extra")
          expect(dependency.version).to eq("3.0.0")
          expect(dependency.requirements).to eq(
            [
              {
                requirement: "2.0.0 <= v <= 3.0.0",
    ...
    context "with <" do
      context "with 0 minor and patch version" do
      end
    ...
    #   let(:elm_package_fixture_name) { "exact_version" }
    ...
    #   let(:elm_package_fixture_name) { "no_requirement" }
    ...
    #   let(:elm_package_fixture_name) { "regex_version" }
    ...
    #   let(:elm_package_fixture_name) { "development_dependency" }
    ...
    #   let(:elm_package_fixture_name) { "git_source" }
    ...
    #     let(:elm_package_fixture_name) { "git_source_with_charlist" }
    ...
    #   let(:elm_package_fixture_name) { "old_elixir" }
    ...
    #   let(:elm_package_fixture_name) { "really_old_elixir" }
    ...
    #   let(:elm_package_fixture_name) { "loads_file" }
    #   let(:lockfile_fixture_name) { "exact_version" }
    ...
    #   let(:elm_package_fixture_name) { "bad_spec" }
    #   let(:lockfile_fixture_name) { "exact_version" }
    ...
    #   let(:elm_package_fixture_name) { "umbrella" }
