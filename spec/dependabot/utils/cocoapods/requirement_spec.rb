...
require "spec_helper"
require "dependabot/utils/cocoapods/requirement"
require "dependabot/utils/cocoapods/version"

RSpec.describe Dependabot::Utils::CocoaPods::Requirement do
    ...
    context "with exact requirement" do
      ...
      it {
        is_expected.to_not be_satisfied_by(
          Dependabot::Utils::CocoaPods::Version.new("1.0.1")
        )
      }
  ...
  describe "#satisfied_by?" do
    ...
    context "with a Pod::Version" do
      context "for the current version" do
        let(:version) { Dependabot::Utils::CocoaPods::Version.new("1.0.0") }
        it { is_expected.to eq(true) }
      end

      context "for an out-of-range version" do
        let(:version) { Dependabot::Utils::CocoaPods::Version.new("2.0.1") }
