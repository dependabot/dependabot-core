...
RSpec.describe Bump::PullRequestCreator do
  ...
  let(:branch_name) { "bump/bundler/business-1.5.0" }
  ...
  describe "#create" do
    ...
    it "creates a branch for that commit" do
      ...
      expect(WebMock).
        ...
        with(body: {
               ref: "refs/heads/bump/bundler/business-1.5.0",
    ...
    it "creates a PR with the right details" do
      ...
      expect(WebMock).
        ...
        with(
          body: {
            base: "master",
            head: "bump/bundler/business-1.5.0",
    ...
    context "with a directory specified" do
      ...
      let(:branch_name) { "bump/bundler/directory/business-1.5.0" }
      ...
      it "includes the directory in the branch name" do
        ...
        expect(WebMock).
          to have_requested(:post, "#{watched_repo_url}/git/refs").
          with(body: {
                 ref: "refs/heads/bump/bundler/directory/business-1.5.0",
                 sha: "7638417db6d59f3c431d3e1f261cc637155684cd"
               })
      end
      ...
      it "includes the directory in the PR title" do
        ...
        expect(WebMock).
          ...
          with(
            body: {
              base: "master",
              head: "bump/bundler/directory/business-1.5.0",
