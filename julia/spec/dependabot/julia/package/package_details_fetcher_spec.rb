...
RSpec.describe Dependabot::Julia::Package::PackageDetailsFetcher do
  ...
  describe "#fetch_package_releases" do
    ...
    it "returns an array of PackageRelease objects" do
      ...
      expect(releases.all? { |r| r.is_a?(Dependabot::Package::PackageRelease) }).to be true
    end
    ...
    it "includes release dates when available" do
      ...
      release_0_5_0 = releases.find { |r| r.version.to_s == "0.5.0" }
      release_0_5_1 = releases.find { |r| r.version.to_s == "0.5.1" }
      release_0_5_2 = releases.find { |r| r.version.to_s == "0.5.2" }
      
      expect(release_0_5_0.released_at).to eq(release_date1)
      expect(release_0_5_1.released_at).to eq(release_date2)
      expect(release_0_5_2.released_at).to be_nil
    end
    ...
    context "when release date fetching fails for some versions" do
      ...
      it "creates release without date and logs warning" do
        ...
        expect(release_0_5_1.released_at).to be_nil
