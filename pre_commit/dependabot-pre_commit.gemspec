...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-pre_commit"
  spec.summary      = "Provides Dependabot support for PreCommit"
  spec.description  = "Dependabot-PreCommit provides support for bumping PreCommit dependencies via Dependabot. " \
