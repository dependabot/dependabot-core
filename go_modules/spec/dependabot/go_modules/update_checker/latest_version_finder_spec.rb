...
RSpec.describe Dependabot::GoModules::UpdateChecker::LatestVersionFinder do
  ...
  describe "#latest_version" do
    ...
    context "with a Git pseudo-version with pre-releases available" do
    ...
    context "with a Git psuedo-version with releases available" do
    ...
    context "with a Git pseudo-version that is later than all releases" do
