...
module Dependabot
  module Nub
    class Version < Dependabot::Version
      ...
      sig { override.params(version: VersionParameter).returns(Dependabot::Nub::Version) }
      def self.new(version)
        T.cast(super, Dependabot::Nub::Version)
      end
      ...
      sig { params(other: Dependabot::Nub::Version).returns(T::Boolean) }
...
Dependabot::Utils
  .register_version_class("nub", Dependabot::Nub::Version)
