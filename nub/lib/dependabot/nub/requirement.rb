...
module Dependabot
  module Nub
    class Requirement < Dependabot::Requirement
      ...
      version_pattern = "v?#{Nub::Version::VERSION_PATTERN}"
      ...
      sig do
        params(
          ...
          .returns(T::Array[T.any(String, T.nilable(Nub::Version))])
      end
      def self.parse(obj)
        return ["=", nil] if obj.is_a?(String) && Version::VERSION_TAGS.include?(obj.strip)
        return ["=", Nub::Version.new(obj.to_s)] if obj.is_a?(Gem::Version)
        ...
        [matches[1] || "=", Nub::Version.new(T.must(matches[2]))]
      end
