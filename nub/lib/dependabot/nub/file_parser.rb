  ...
  module Nub
    class FileParser < Dependabot::FileParsers::Base # rubocop:disable Metrics/ClassLength
      ...
      def nub_lock
        @nub_lock ||= T.let(
          dependency_files.find do |f|
            f.name.end_with?(NubPackageManager::LOCKFILE_NAME)
          end,
          T.nilable(Dependabot::DependencyFile)
        )
      end
      ...
      def npmrc
        @npmrc ||= T.let(
          dependency_files.find do |f|
            f.name.end_with?(NubPackageManager::RC_FILENAME)
          end,
          T.nilable(Dependabot::DependencyFile)
        )
      end
      ...
      def lockfile_parser
        @lockfile_parser ||= T.let(
          ...
          T.nilable(Dependabot::Nub::FileParser::LockfileParser)
        )
      end
      ...
      sig { returns(T.class_of(Dependabot::Nub::Requirement)) }
...
Dependabot::FileParsers
  .register(Dependabot::Nub::ECOSYSTEM, Dependabot::Nub::FileParser)
