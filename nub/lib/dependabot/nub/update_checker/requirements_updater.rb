  ...
  module Nub
    class UpdateChecker
      class RequirementsUpdater
        ...
        sig { returns(T.nilable(Nub::Version)) }
        ...
        sig { params(requirement_string: String).returns(T::Array[Nub::Requirement]) }
        ...
        sig { params(old_version: String, version_to_be_permitted: Nub::Version).returns(String) }
        ...
        sig { returns(T.class_of(Nub::Version)) }
        def version_class
          Nub::Version
        end
      end
