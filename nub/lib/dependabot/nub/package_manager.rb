...
require "dependabot/nub/version_selector"
require "dependabot/nub/registry_helper"
require "dependabot/nub/nub_package_manager"
require "dependabot/nub/language"
require "dependabot/nub/constraint_helper"
  ...
  module Nub
    ...
    class PackageManagerHelper
      ...
      def guessed_version(name)
        ...
        version = Helpers.nub_version_numeric(lockfile)
      ...
      def check_engine_version(name)
        ...
        engine_versions = version_selector.setup(@engines, name, NubPackageManager::SUPPORTED_VERSIONS)
