...
require "dependabot/nub/update_checker/latest_version_finder"
require "dependabot/credential"
require "dependabot/security_advisory"
require "dependabot/package/release_cooldown_options"
require "dependabot/nub/version"
require "dependabot/nub/package/package_details_fetcher"

MAX_COOLDOWN_DAYS = 100 * 365

RSpec.describe Dependabot::Nub::UpdateChecker::PackageLatestVersionFinder do
  ...
  describe "#latest_version_from_registry" do
    ...
    context "when cooldown is configured and the release date is unavailable" do
      ...
      it "allows the release and marks the dependency" do
        expect(latest_version_from_registry).to eq(Dependabot::Nub::Version.new("1.7.0"))
    ...
    context "when dealing with a dependency hosted on another registry" do
      ...
      context "when the request times out" do
        ...
        context "when dealing with a git dependency" do
          before do
            allow_any_instance_of(Dependabot::Nub::Package::PackageDetailsFetcher) # rubocop:disable RSpec/AnyInstance
      ...
      context "with credentials" do
        ...
        context "when the latest version has been yanked" do
          ...
          it { is_expected.to eq(Dependabot::Nub::Version.new("1.8.0")) }
        end
      ...
      context "without credentials" do
        ...
        context "with credentials in the .npmrc" do
          ...
          let(:project_name) { "javascript/npmrc_auth_token" }

          it { is_expected.to eq(Gem::Version.new("1.8.1")) }

          context "when it require an environment variable" do
            let(:project_name) { "javascript/npmrc_env_auth_token" }
  ...
  describe "#possible_versions" do
    ...
    it "returns a list of versions" do
      expect(possible_versions).to eq(
        [
          Dependabot::Nub::Version.new("1.7.0"),
          Dependabot::Nub::Version.new("1.6.0"),
          Dependabot::Nub::Version.new("1.5.1"),
          Dependabot::Nub::Version.new("1.5.0"),
          Dependabot::Nub::Version.new("1.4.0"),
          Dependabot::Nub::Version.new("1.3.1"),
          Dependabot::Nub::Version.new("1.3.0"),
          Dependabot::Nub::Version.new("1.2.1"),
          Dependabot::Nub::Version.new("1.2.0"),
          Dependabot::Nub::Version.new("1.1.0"),
          Dependabot::Nub::Version.new("1.0.1"),
          Dependabot::Nub::Version.new("1.0.0")
        ]
      )
    end
