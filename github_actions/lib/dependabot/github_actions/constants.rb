...
module Dependabot
  module GithubActions
    ...
    # The basename of the per-repo Actions lockfile generated by gh-actions-pin
    ...
    # The only lockfile schema version this ecosystem understands. Bumping the
    # gh-actions-pin lockfile major requires explicit support here (see
    # Lockfile::VersionGate).
    SUPPORTED_LOCKFILE_VERSION = T.let("v0.0.1", String)
