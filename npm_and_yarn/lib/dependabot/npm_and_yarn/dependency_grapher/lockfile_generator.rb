      ...
      class LockfileGenerator
        ...
        def write_package_files
          dependency_files.each do |file|
            next unless file.name.end_with?("package.json") ||
                        file.name.end_with?(".npmrc") ||
                        file.name.end_with?(".yarnrc") ||
                        file.name.end_with?(".yarnrc.yml") ||
                        file.name.end_with?("pnpm-workspace.yaml")
