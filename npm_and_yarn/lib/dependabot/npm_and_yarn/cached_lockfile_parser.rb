...
module Dependabot
  module NpmAndYarn
    class CachedLockfileParser
      ...
      sig { params(dependency_files: T::Array[Dependabot::DependencyFile]).returns(Dependabot::NpmAndYarn::FileParser::LockfileParser) }
      def self.parse(dependency_files:)
        ...
        @cache[lockfile_hash] = Dependabot::NpmAndYarn::FileParser::LockfileParser.new(dependency_files: dependency_files)
      end
    end
  end
end
