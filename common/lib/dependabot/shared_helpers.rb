...
module Dependabot
  module SharedHelpers
    ...
    def self.with_git_configured(credentials:, repo_path:)
      backup_git_config_path = stash_global_git_config
      configure_git_to_use_https_with_credentials(credentials, repo_path)
      yield
    ...
    def self.configure_git_to_use_https_with_credentials(credentials, repo_path = nil)
