      ...
      def fetch_files
        unless allow_beta_ecosystems?
          raise Dependabot::DependencyFileNotFound.new(
            ...
            "top-level of your `dependabot.yml`. See https://docs.github.com/en/code-security/dependabot/" \
            "working-with-dependabot/dependabot-options-reference#enable-beta-ecosystems for details."
          )
        end
