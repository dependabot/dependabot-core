...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-bazel"
  spec.summary      = "Provides Dependabot support for Bazel"
  spec.description  = "Dependabot-Bazel provides support for bumping Bazel dependencies via Dependabot. " \
