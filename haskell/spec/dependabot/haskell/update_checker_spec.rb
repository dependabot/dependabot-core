...
RSpec.describe Dependabot::Haskell::UpdateChecker do
  ...
  let(:dependency) do
    Dependabot::Dependency.new(
      ...
      requirements: [{
        ...
        file: "Cabal.cabal",
        source: nil,
        metadata: { declaration_string: "acme-missiles == 0.2.1" }
      }],
      package_manager: "haskell"
    )
  end
  let(:dependency_name) { "acme-missiles" }
  ...
  shared_context "with multiple git sources", :vcr do
    let(:dependency) do
      Dependabot::Dependency.new(
  ...
  describe "#latest_version", :vcr do
  ...
  describe "#latest_resolvable_version", :vcr do
  ...
  describe "#updated_requirements", :vcr do
