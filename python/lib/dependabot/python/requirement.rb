...
module Dependabot
  module Python
    class Requirement < Dependabot::Requirement
      ...
      sig do
        params(obj: Object)
          .returns(T.any(T::Array[String], Requirement, [String, Dependabot::Python::Version]))
      end
      def self.parse(obj)
      ...
      sig { params(version: T.any(Gem::Version, Python::Version, String)).returns(T::Boolean) }
      ...
      sig { params(req_string: T.untyped).returns(T.any(String, T::Array[String])) }
