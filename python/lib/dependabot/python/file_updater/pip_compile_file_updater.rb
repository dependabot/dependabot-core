  ...
  module Python
    class FileUpdater
      ...
      class PipCompileFileUpdater
        ...
        sig { params(requirements_file: T.untyped).returns(T::Array[String]) }
        ...
        sig { params(compiled_file: T.untyped).returns(T::Boolean) }
        ...
        sig { params(filenames: T.untyped).returns(T::Array[String]) }
