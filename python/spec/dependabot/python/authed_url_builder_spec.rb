...
RSpec.describe Dependabot::Python::AuthedUrlBuilder do
  describe ".authed_url" do
    ...
    context "with a token" do
      ...
      context "when that doesn't include a :" do
        let(:token) { "token" }
        ...
        context "when that is already base64 encoded" do
      ...
      context "when that includes a :" do
      ...
      context "when that includes an @" do
      ...
      context "when that has multiple colons" do
        let(:token) { "token:pass:23" }
      ...
      context "when that includes an @ and is base64 encoded" do
