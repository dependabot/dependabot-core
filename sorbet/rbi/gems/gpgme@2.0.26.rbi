...
module GPGME
  ...
  class << self
    ...
    #
    # pkg:gem/gpgme#lib/gpgme.rb:148
    ...
    # pkg:gem/gpgme#lib/gpgme.rb:81
    def hash_algo_name(_arg0); end

    # From the c extension
    #
    # pkg:gem/gpgme#lib/gpgme.rb:80
    ...
    #   end
    #
    # pkg:gem/gpgme#lib/gpgme.rb:66
    def thread_safe_mutex; end
  end
end

# pkg:gem/gpgme#lib/gpgme/constants.rb:373
...
#
# pkg:gem/gpgme#lib/gpgme/crypto.rb:14
class GPGME::Crypto
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:18
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:332
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:166
  def decrypt(cipher, options = T.unsafe(nil)); end

  # pkg:gem/gpgme#lib/gpgme/crypto.rb:16
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:342
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:79
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:237
  ...
  #   end
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:306
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/crypto.rb:366
  ...
  class << self
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/crypto.rb:349
...
class GPGME::Ctx
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:453
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:483
  ...
  # a numeric status code (e.g., GPGME::GPGME_STATUS_GET_BOOL).
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:472
  ...
  # a {GPGME::Data} object.
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:429
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:414
  def generate_key(parms, pubkey = T.unsafe(nil), seckey = T.unsafe(nil)); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:419
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:177
  def ignore_mdc_error=(yes); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:443
  def import(keydata); end

  # Add the keys in the data buffer to the key ring.
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:438
  def import_keys(keydata); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:445
  def import_result; end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:614
  def inspect; end
  ...
  # Used by {GPGME::Ctx#each_key}
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:337
  ...
  # Used by {GPGME::Ctx#each_key}
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:328
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:587
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:603
  ...
  #   ctx.release
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:101
  def release; end

  # Set the Ctx flag with the given name
  # to the given value.
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:139
  ...
  # {#pinentry_mode}).
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:282
  def set_passphrase_callback(passfunc, hook_value = T.unsafe(nil)); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:285
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:297
  def set_progress_callback(progfunc, hook_value = T.unsafe(nil)); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:300
  ...
  #  end
  #
  # pkg:gem/gpgme#lib/gpgme/ctx.rb:314
  def set_status_callback(statusfunc, hook_value = T.unsafe(nil)); end

  # pkg:gem/gpgme#lib/gpgme/ctx.rb:317
...
class GPGME::Data
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/data.rb:163
  def encoding; end
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/data.rb:180
  def encoding=(encoding); end

  # Return the file name of the underlying data.
  #
  # pkg:gem/gpgme#lib/gpgme/data.rb:189
  def file_name; end
  ...
  # @raise [GPGME::Error::InvalidValue] if the value isn't accepted.
  #
  # pkg:gem/gpgme#lib/gpgme/data.rb:197
  ...
  #   data.read(4) # => "From"
  #
  # pkg:gem/gpgme#lib/gpgme/data.rb:112
  ...
  class << self
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/data.rb:41
    def new(object = T.unsafe(nil)); end
  end
end

# pkg:gem/gpgme#lib/gpgme/data.rb:12
GPGME::Data::BLOCK_SIZE = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::DecryptResult
  # pkg:gem/gpgme#lib/gpgme/misc.rb:25
  def file_name; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:25
  def recipients; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:24
...
# installation.
#
# pkg:gem/gpgme#lib/gpgme/engine.rb:6
module GPGME::Engine
  class << self
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/engine.rb:18
    ...
    #   # => '/home/user/.gnupg"
    #
    # pkg:gem/gpgme#lib/gpgme/engine.rb:82
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/engine.rb:70
    ...
    #          @version="1.4.11">
    #
    # pkg:gem/gpgme#lib/gpgme/engine.rb:35
    def info; end
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/engine.rb:57
...
class GPGME::EngineInfo
  # pkg:gem/gpgme#lib/gpgme/misc.rb:5
  def file_name; end
  ...
  # pkg:gem/gpgme#lib/gpgme/misc.rb:6
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/misc.rb:3
    def new(*_arg0); end
  end
end

# pkg:gem/gpgme#lib/gpgme/error.rb:2
class GPGME::Error < ::StandardError
  # pkg:gem/gpgme#lib/gpgme/error.rb:3
  ...
  # an operation failed.
  #
  # pkg:gem/gpgme#lib/gpgme/error.rb:12
  def code; end

  # pkg:gem/gpgme#lib/gpgme/error.rb:6
  def error; end

  # Return a description of the error code.
  #
  # pkg:gem/gpgme#lib/gpgme/error.rb:29
  def message; end
...
# pkg:gem/gpgme#lib/gpgme/error.rb:35
class GPGME::Error::UnusablePublicKey < ::GPGME::Error
  # pkg:gem/gpgme#lib/gpgme/error.rb:36
  def keys; end
...
# pkg:gem/gpgme#lib/gpgme/error.rb:38
class GPGME::Error::UnusableSecretKey < ::GPGME::Error
  # pkg:gem/gpgme#lib/gpgme/error.rb:39
  def keys; end
...
# pkg:gem/gpgme#lib/gpgme/error.rb:49
class GPGME::Error::WrongKeyUsage < ::GPGME::Error
  # pkg:gem/gpgme#lib/gpgme/error.rb:50
  def key_usage; end
...
GPGME::GPGME_CREATE_GROUP = T.let(T.unsafe(nil), Integer)
...
GPGME::GPGME_RANDOM_MODE_NORMAL = T.let(T.unsafe(nil), Integer)
GPGME::GPGME_RANDOM_MODE_ZBASE32 = T.let(T.unsafe(nil), Integer)
...
# pkg:gem/gpgme#lib/gpgme/constants.rb:122
GPGME::IMPORT_NEW = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:123
GPGME::IMPORT_SECRET = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:124
GPGME::IMPORT_SIG = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:125
GPGME::IMPORT_SUBKEY = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:126
GPGME::IMPORT_UID = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/io_callbacks.rb:2
class GPGME::IOCallbacks
  # pkg:gem/gpgme#lib/gpgme/io_callbacks.rb:3
  def initialize(io); end

  # pkg:gem/gpgme#lib/gpgme/io_callbacks.rb:7
  def read(hook, length); end

  # pkg:gem/gpgme#lib/gpgme/io_callbacks.rb:20
  def seek(hook, offset, whence); end

  # pkg:gem/gpgme#lib/gpgme/io_callbacks.rb:11
  def write(hook, buffer, length); end
end

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::ImportResult
  # pkg:gem/gpgme#lib/gpgme/misc.rb:68
  def considered; end
  ...
  # pkg:gem/gpgme#lib/gpgme/misc.rb:71
  def imports; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:69
  ...
  # pkg:gem/gpgme#lib/gpgme/misc.rb:70
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/misc.rb:66
    def new(*_arg0); end
  end
end
...
class GPGME::ImportStatus
  # pkg:gem/gpgme#lib/gpgme/misc.rb:62
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:61
  def fpr; end
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/misc.rb:59
    def new(*_arg0); end
  end
end
...
class GPGME::InvalidKey
  # pkg:gem/gpgme#lib/gpgme/misc.rb:44
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:43
  def fpr; end
...
class GPGME::Key
  ...
  # pkg:gem/gpgme#lib/gpgme/key.rb:225
  def ==(another_key); end

  # pkg:gem/gpgme#lib/gpgme/key.rb:17
  def chain_id; end

  # Returns the issuer comment for this key.
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:221
  def comment; end
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:161
  def delete!(allow_secret = T.unsafe(nil), force = T.unsafe(nil)); end

  # Returns the email for this key.
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:209
  def email; end

  # Returns true if the key is expired
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:181
  def expired; end

  # Returns the expiry date for this key
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:175
  def expires; end

  # Returns true if the key has an expiry date else false
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:169
  def expires?; end
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:153
  def export(options = T.unsafe(nil)); end

  # Longer descriptive value. Can be used to identify the key.
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:197
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/key.rb:229
  def inspect; end
  ...
  # pkg:gem/gpgme#lib/gpgme/key.rb:16
  def keylist_mode; end

  # Returns the issuer name for this key.
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:215
  def name; end

  # pkg:gem/gpgme#lib/gpgme/key.rb:16
  def owner_trust; end

  # pkg:gem/gpgme#lib/gpgme/key.rb:185
  def primary_subkey; end

  # Returns the main {GPGME::UserID} for this key.
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:203
  def primary_uid; end
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/key.rb:191
  def sha; end

  # pkg:gem/gpgme#lib/gpgme/key.rb:18
  def subkeys; end

  # pkg:gem/gpgme#lib/gpgme/key.rb:244
  def to_s; end
  ...
  class << self
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/key.rb:96
    ...
    #
    # pkg:gem/gpgme#lib/gpgme/key.rb:125
    def import(keydata, options = T.unsafe(nil)); end

    # Checks if a key is valid
    #
    # pkg:gem/gpgme#lib/gpgme/key.rb:133
    def valid?(key); end

    private

    # pkg:gem/gpgme#lib/gpgme/key.rb:14
    def new(*_arg0); end
  end
end

# pkg:gem/gpgme#lib/gpgme/key_common.rb:2
module GPGME::KeyCommon
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/key_common.rb:17
  def capability; end

  # pkg:gem/gpgme#lib/gpgme/key_common.rb:39
  def secret?; end

  # Returns nil if the trust is valid.
  # Returns one of +:revoked+, +:expired+, +:disabled+, +:invalid+
  #
  # pkg:gem/gpgme#lib/gpgme/key_common.rb:7
  def trust; end
  ...
  #
  # pkg:gem/gpgme#lib/gpgme/key_common.rb:31
  def usable_for?(purposes); end
end

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::KeySig
  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:11
  def expired?; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:27
  def expires; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:19
  def exportable?; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:31
  def inspect; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:15
  def invalid?; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:5
  def keyid; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:5
  def pubkey_algo; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:7
  def revoked?; end

  # pkg:gem/gpgme#lib/gpgme/key_sig.rb:23
  def timestamp; end

  class << self
    private

    # pkg:gem/gpgme#lib/gpgme/key_sig.rb:3
    def new(*_arg0); end
  end
end

# pkg:gem/gpgme#lib/gpgme/constants.rb:140
GPGME::MD_CRC24_RFC2440 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:141
GPGME::MD_CRC32 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:142
GPGME::MD_CRC32_RFC1510 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:143
GPGME::MD_HAVAL = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:144
GPGME::MD_MD2 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:145
GPGME::MD_MD4 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:146
GPGME::MD_MD5 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:147
GPGME::MD_RMD160 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:148
GPGME::MD_SHA1 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:149
GPGME::MD_SHA256 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:153
GPGME::MD_SHA384 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:154
GPGME::MD_SHA512 = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:155
GPGME::MD_TIGER = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::NewSignature
  # pkg:gem/gpgme#lib/gpgme/misc.rb:51
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/misc.rb:50
  def fpr; end
  ...
  # pkg:gem/gpgme#lib/gpgme/misc.rb:53
  def timestamp; end
...
class GPGME::SignResult
  # pkg:gem/gpgme#lib/gpgme/misc.rb:31
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/misc.rb:29
    def new(*_arg0); end
  end
end
...
class GPGME::Signature
  # pkg:gem/gpgme#lib/gpgme/signature.rb:28
  def bad?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:64
  def exp_timestamp; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:20
  def expired_key?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:16
  def expired_signature?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:8
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:5
  def fpr; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:40
  def from; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:52
  def key; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:32
  def no_key?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:5
  def notations; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:7
  def pka_address; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:7
  def pka_trust; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:24
  def revoked_key?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:5
  def status; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:36
  def status_code; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:5
  def summary; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:60
  def timestamp; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:68
  def to_s; end

  # Returns true if the signature is correct
  #
  # pkg:gem/gpgme#lib/gpgme/signature.rb:12
  def valid?; end

  # pkg:gem/gpgme#lib/gpgme/signature.rb:6
  def validity; end
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/signature.rb:3
    def new(*_arg0); end
  end
end
...
class GPGME::SubKey
  ...
  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:28
  def expired; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:24
  def expires; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:20
  def expires?; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:6
  def fingerprint; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:5
  def fpr; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:47
  def inspect; end
  ...
  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:43
  def pubkey_algo_letter; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:32
  def sha; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:10
  def timestamp; end

  # pkg:gem/gpgme#lib/gpgme/sub_key.rb:58
  def to_s; end

  class << self
    private

    # pkg:gem/gpgme#lib/gpgme/sub_key.rb:3
    def new(*_arg0); end
  end
end

# pkg:gem/gpgme#lib/gpgme/sub_key.rb:36
GPGME::SubKey::PUBKEY_ALGO_LETTERS = T.let(T.unsafe(nil), Hash)

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::UserID
  # pkg:gem/gpgme#lib/gpgme/user_id.rb:5
  def comment; end

  # pkg:gem/gpgme#lib/gpgme/user_id.rb:5
  def email; end

  # pkg:gem/gpgme#lib/gpgme/user_id.rb:15
  def inspect; end

  # pkg:gem/gpgme#lib/gpgme/user_id.rb:11
  def invalid?; end

  # pkg:gem/gpgme#lib/gpgme/user_id.rb:5
  def name; end

  # pkg:gem/gpgme#lib/gpgme/user_id.rb:7
  def revoked?; end
  ...
  class << self
    ...
    # pkg:gem/gpgme#lib/gpgme/user_id.rb:3
    def new(*_arg0); end
  end
end

# pkg:gem/gpgme#lib/gpgme/constants.rb:295
GPGME::VALIDITY_FULL = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:296
GPGME::VALIDITY_MARGINAL = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:340
GPGME::VALIDITY_NAMES = T.let(T.unsafe(nil), Hash)

# pkg:gem/gpgme#lib/gpgme/constants.rb:297
GPGME::VALIDITY_NEVER = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:298
GPGME::VALIDITY_ULTIMATE = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:299
GPGME::VALIDITY_UNDEFINED = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme/constants.rb:300
GPGME::VALIDITY_UNKNOWN = T.let(T.unsafe(nil), Integer)

# pkg:gem/gpgme#lib/gpgme.rb:1
class GPGME::VerifyResult
  # pkg:gem/gpgme#lib/gpgme/misc.rb:12
  def signatures; end

  class << self
    private

    # pkg:gem/gpgme#lib/gpgme/misc.rb:10
    def new(*_arg0); end
  end
end
