...
class ParseConfig
  ...
  #
  # source://parseconfig//lib/parseconfig.rb#28
  ...
  #
  # source://parseconfig//lib/parseconfig.rb#167
  def add_to_group(group, param_name, value); end

  # Returns the value of attribute config_file.
  #
  # source://parseconfig//lib/parseconfig.rb#20
  def config_file; end
  ...
  # @return [Boolean]
  #
  # source://parseconfig//lib/parseconfig.rb#205
  def eql?(other); end

  # source://parseconfig//lib/parseconfig.rb#107
  def escaped_comment_regex; end

  # List available sub-groups of the config.
  #
  # source://parseconfig//lib/parseconfig.rb#134
  def get_groups; end

  # This method returns all parameters/groups defined in a config file.
  #
  # source://parseconfig//lib/parseconfig.rb#129
  def get_params; end
  ...
  #
  # source://parseconfig//lib/parseconfig.rb#117
  ...
  #
  # source://parseconfig//lib/parseconfig.rb#51
  ...
  # @raise [Errno::EACCES]
  #
  # source://parseconfig//lib/parseconfig.rb#42
  def validate_config; end

  # Writes out the config file to output_stream
  #
  # source://parseconfig//lib/parseconfig.rb#173
