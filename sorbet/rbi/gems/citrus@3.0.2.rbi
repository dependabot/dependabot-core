...
#
# source://citrus//lib/citrus/file.rb#31
module Citrus::File
...
class Citrus::Input < ::StringScanner
  ...
  # given +pos+. +pos+ defaults to the current pointer position.
  #
  # source://citrus//lib/citrus.rb#230
  ...
  #
  # source://citrus//lib/citrus.rb#269
  def to_str; end
...
class Citrus::Match
  ...
  # source://citrus//lib/citrus.rb#1392
  def eql?(other); end
  ...
  # Returns the slice of the source text that this match captures.
  #
  # source://citrus//lib/citrus.rb#1350
  def to_s; end
  ...
  #
  # source://citrus//lib/citrus.rb#1357
  def to_str; end
  ...
  # interpretation.
  #
  # source://citrus//lib/citrus.rb#1362
  def value; end
...
module Citrus::Rule
  ...
  # source://citrus//lib/citrus.rb#741
  def eql?(other); end
  ...
  #
  # source://citrus//lib/citrus.rb#720
  def to_str; end
...
class Citrus::StringTerminal < ::Citrus::Terminal
  ...
  # source://citrus//lib/citrus.rb#960
  def eql?(other); end
...
class Citrus::Terminal
  ...
  # source://citrus//lib/citrus.rb#915
  def eql?(other); end
