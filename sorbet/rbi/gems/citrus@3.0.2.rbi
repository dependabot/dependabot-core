...
#
# pkg:gem/citrus#lib/citrus/version.rb:1
module Citrus
  class << self
    ...
    # twice.
    #
    # pkg:gem/citrus#lib/citrus.rb:29
    def cache; end
    ...
    #     # => [MyGrammar]
    #
    # pkg:gem/citrus#lib/citrus.rb:46
    ...
    #     # => [MyGrammar]
    #
    # pkg:gem/citrus#lib/citrus.rb:71
    ...
    #     # => [MyGrammar]
    #
    # pkg:gem/citrus#lib/citrus.rb:96
    ...
    #     # => #<Citrus::Rule: ... >
    #
    # pkg:gem/citrus#lib/citrus.rb:56
    def rule(expr, options = T.unsafe(nil)); end

    # Returns the current version of Citrus as a string.
    #
    # pkg:gem/citrus#lib/citrus/version.rb:6
    def version; end
  end
end
...
#     name
#
# pkg:gem/citrus#lib/citrus.rb:809
class Citrus::Alias
  include ::Citrus::Rule
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:813
  def to_citrus; end
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:821
  def resolve!; end
end
...
#     &expr
#
# pkg:gem/citrus#lib/citrus.rb:998
class Citrus::AndPredicate
  include ::Citrus::Rule
  include ::Citrus::Nonterminal

  # pkg:gem/citrus#lib/citrus.rb:1001
  def initialize(rule = T.unsafe(nil)); end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1011
  def exec(input, events = T.unsafe(nil)); end

  # Returns the Rule object this rule uses to match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1006
  def rule; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1022
  def to_citrus; end
end
...
#     ~expr
#
# pkg:gem/citrus#lib/citrus.rb:1068
class Citrus::ButPredicate
  include ::Citrus::Rule
  include ::Citrus::Nonterminal

  # pkg:gem/citrus#lib/citrus.rb:1073
  def initialize(rule = T.unsafe(nil)); end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1083
  def exec(input, events = T.unsafe(nil)); end

  # Returns the Rule object this rule uses to match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1078
  def rule; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1102
  def to_citrus; end
end

# pkg:gem/citrus#lib/citrus.rb:1071
Citrus::ButPredicate::DOT_RULE = T.let(T.unsafe(nil), Citrus::Terminal)

# pkg:gem/citrus#lib/citrus.rb:20
...
#     expr | expr
#
# pkg:gem/citrus#lib/citrus.rb:1233
class Citrus::Choice
  include ::Citrus::Rule
  include ::Citrus::Nonterminal
  ...
  # its event stream.
  #
  # pkg:gem/citrus#lib/citrus.rb:1260
  def elide?; end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1237
  def exec(input, events = T.unsafe(nil)); end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1265
  def to_citrus; end
end

# A pattern to match any character, including newline.
#
# pkg:gem/citrus#lib/citrus.rb:16
Citrus::DOT = T.let(T.unsafe(nil), Regexp)

# A base class for all Citrus errors.
#
# pkg:gem/citrus#lib/citrus.rb:117
...
#
# pkg:gem/citrus#lib/citrus/file.rb:31
module Citrus::File
  include ::Citrus::Grammar
  extend ::Citrus::GrammarMethods

  class << self
    # pkg:gem/citrus#lib/citrus/file.rb:357
    def parse(*_arg0); end
  end
end
...
#
# pkg:gem/citrus#lib/citrus.rb:352
module Citrus::Grammar
  ...
  class << self
    ...
    #
    # pkg:gem/citrus#lib/citrus.rb:368
    ...
    #
    # pkg:gem/citrus#lib/citrus.rb:360
    def new(&block); end
  end
end
...
#
# pkg:gem/citrus#lib/citrus.rb:376
module Citrus::GrammarMethods
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:497
  def dot(&block); end
  ...
  #           grammar's #root.
  #
  # pkg:gem/citrus#lib/citrus.rb:387
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:397
  ...
  # provided to specify semantic behavior (via #ext).
  #
  # pkg:gem/citrus#lib/citrus.rb:528
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:482
  ...
  # grammar.
  #
  # pkg:gem/citrus#lib/citrus.rb:459
  ...
  # +name+.
  #
  # pkg:gem/citrus#lib/citrus.rb:432
  def setup_super(rule, name); end

  class << self
    # pkg:gem/citrus#lib/citrus.rb:377
    def extend_object(obj); end
  end
end

# pkg:gem/citrus#lib/citrus.rb:18
...
#
# pkg:gem/citrus#lib/citrus.rb:172
class Citrus::Input < ::StringScanner
  # pkg:gem/citrus#lib/citrus.rb:173
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:246
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:234
...
#
# pkg:gem/citrus#lib/citrus.rb:1274
class Citrus::Match
  # pkg:gem/citrus#lib/citrus.rb:1275
  def initialize(input, events = T.unsafe(nil), offset = T.unsafe(nil)); end

  # pkg:gem/citrus#lib/citrus.rb:1381
  def ==(other); end
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:1400
  def dump(indent = T.unsafe(nil)); end

  # pkg:gem/citrus#lib/citrus.rb:1392
  def eql?(other); end

  # The array of events for this match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1310
  def events; end

  # A shortcut for retrieving the first immediate submatch of this match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1346
  def first; end

  # The original Input this Match was generated on.
  #
  # pkg:gem/citrus#lib/citrus.rb:1304
  def input; end

  # pkg:gem/citrus#lib/citrus.rb:1394
  def inspect; end

  # Returns the length of this match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1313
  def length; end

  # Returns an array of all immediate submatches of this match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1340
  def matches; end

  # The index of this match in the #input.
  #
  # pkg:gem/citrus#lib/citrus.rb:1307
  def offset; end

  # Convenient shortcut for +input.source+
  #
  # pkg:gem/citrus#lib/citrus.rb:1318
  def source; end

  # Returns the slice of the source text that this match captures.
  #
  # pkg:gem/citrus#lib/citrus.rb:1323
  def string; end

  # Returns this match plus all sub #matches in an array.
  #
  # pkg:gem/citrus#lib/citrus.rb:1365
  def to_a; end

  # pkg:gem/citrus#lib/citrus.rb:1350
  def to_s; end
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:1357
  def to_str; end
  ...
  # interpretation.
  #
  # pkg:gem/citrus#lib/citrus.rb:1362
  def value; end

  private

  # pkg:gem/citrus#lib/citrus.rb:1511
...
#
# pkg:gem/citrus#lib/citrus.rb:298
class Citrus::MemoizedInput < ::Citrus::Input
  # pkg:gem/citrus#lib/citrus.rb:299
  def initialize(string); end

  # A nested hash of rules to offsets and their respective matches.
  #
  # pkg:gem/citrus#lib/citrus.rb:306
  def cache; end

  # The number of times the cache was hit.
  #
  # pkg:gem/citrus#lib/citrus.rb:309
  def cache_hits; end

  # Returns +true+ when using memoization to cache match results.
  #
  # pkg:gem/citrus#lib/citrus.rb:318
  def memoized?; end

  # pkg:gem/citrus#lib/citrus.rb:311
  def reset; end

  private

  # pkg:gem/citrus#lib/citrus.rb:324
  def apply_rule(rule, position, events); end
end
...
#
# pkg:gem/citrus#lib/citrus/file.rb:8
module Citrus::ModuleNameHelpers
  # pkg:gem/citrus#lib/citrus/file.rb:23
  def module_basename; end

  # pkg:gem/citrus#lib/citrus/file.rb:9
  def module_name; end

  # pkg:gem/citrus#lib/citrus/file.rb:17
  def module_namespace; end

  # pkg:gem/citrus#lib/citrus/file.rb:13
...
#     !expr
#
# pkg:gem/citrus#lib/citrus.rb:1033
class Citrus::NotPredicate
  include ::Citrus::Rule
  include ::Citrus::Nonterminal

  # pkg:gem/citrus#lib/citrus.rb:1036
  def initialize(rule = T.unsafe(nil)); end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1046
  def exec(input, events = T.unsafe(nil)); end

  # Returns the Rule object this rule uses to match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1041
  def rule; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1057
  def to_citrus; end
end

# Raised when a parse fails.
#
# pkg:gem/citrus#lib/citrus.rb:123
class Citrus::ParseError < ::Citrus::Error
  # The +input+ given here is an instance of Citrus::Input.
  #
  # pkg:gem/citrus#lib/citrus.rb:125
  ...
  # occurred.
  #
  # pkg:gem/citrus#lib/citrus.rb:140
  def offset; end
end
...
#
# pkg:gem/citrus#lib/citrus.rb:756
module Citrus::Proxy
  include ::Citrus::Rule

  # pkg:gem/citrus#lib/citrus.rb:759
  def initialize(rule_name = T.unsafe(nil)); end

  # Returns +true+ if this rule should extend a match but should not appear in
  # its event stream.
  #
  # pkg:gem/citrus#lib/citrus.rb:791
  def elide?; end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:777
  def exec(input, events = T.unsafe(nil)); end

  # pkg:gem/citrus#lib/citrus.rb:795
  def extend_match(match); end

  # Returns the underlying Rule for this proxy.
  #
  # pkg:gem/citrus#lib/citrus.rb:772
  def rule; end

  # The name of this proxy's rule.
  #
  # pkg:gem/citrus#lib/citrus.rb:769
  def rule_name; end

  # Sets the name of the rule this rule is proxy for.
  #
  # pkg:gem/citrus#lib/citrus.rb:764
...
#     expr?
#
# pkg:gem/citrus#lib/citrus.rb:1126
class Citrus::Repeat
  include ::Citrus::Rule
  include ::Citrus::Nonterminal

  # pkg:gem/citrus#lib/citrus.rb:1129
  def initialize(rule = T.unsafe(nil), min = T.unsafe(nil), max = T.unsafe(nil)); end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1142
  def exec(input, events = T.unsafe(nil)); end

  # The maximum number of times this rule may match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1169
  def max; end

  # The minimum number of times this rule must match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1166
  def min; end

  # Returns the operator this rule uses as a string. Will be one of
  # <tt>+</tt>, <tt>?</tt>, or <tt>N*M</tt>.
  #
  # pkg:gem/citrus#lib/citrus.rb:1173
  def operator; end

  # Returns the Rule object this rule uses to match.
  #
  # pkg:gem/citrus#lib/citrus.rb:1137
  def rule; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1184
  def to_citrus; end
end
...
#
# pkg:gem/citrus#lib/citrus.rb:587
module Citrus::Rule
  # pkg:gem/citrus#lib/citrus.rb:732
  def ==(other); end

  # Tests the given +obj+ for case equality with this rule.
  #
  # pkg:gem/citrus#lib/citrus.rb:685
  def ===(obj); end

  # The default set of options to use when calling #parse.
  #
  # pkg:gem/citrus#lib/citrus.rb:641
  def default_options; end

  # Returns +true+ if this rule should extend a match but should not appear in
  # its event stream.
  #
  # pkg:gem/citrus#lib/citrus.rb:696
  def elide?; end

  # pkg:gem/citrus#lib/citrus.rb:741
  def eql?(other); end

  # pkg:gem/citrus#lib/citrus.rb:747
  def extend_match(match); end

  # The module this rule uses to extend new matches.
  #
  # pkg:gem/citrus#lib/citrus.rb:638
  def extension; end
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:627
  def extension=(mod); end

  # The grammar this rule belongs to, if any.
  #
  # pkg:gem/citrus#lib/citrus.rb:604
  def grammar; end
  ...
  # pkg:gem/citrus#lib/citrus.rb:743
  def inspect; end
  ...
  # using that label.
  #
  # pkg:gem/citrus#lib/citrus.rb:622
  def label; end

  # Sets the label of this rule.
  #
  # pkg:gem/citrus#lib/citrus.rb:615
  def label=(label); end

  # The name of this rule.
  #
  # pkg:gem/citrus#lib/citrus.rb:612
  def name; end

  # Sets the name of this rule.
  #
  # pkg:gem/citrus#lib/citrus.rb:607
  def name=(name); end

  # Returns +true+ if this rule needs to be surrounded by parentheses when
  # using #to_embedded_s.
  #
  # pkg:gem/citrus#lib/citrus.rb:702
  def needs_paren?; end
  ...
  #             to 0.
  #
  # pkg:gem/citrus#lib/citrus.rb:658
  def parse(source, options = T.unsafe(nil)); end

  # Returns +true+ if this rule is a Terminal.
  #
  # pkg:gem/citrus#lib/citrus.rb:690
  def terminal?; end
  ...
  # +options+ as #parse.
  #
  # pkg:gem/citrus#lib/citrus.rb:678
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:724
  def to_embedded_s; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:707
  def to_s; end
  ...
  #
  # pkg:gem/citrus#lib/citrus.rb:720
  def to_str; end

  class << self
    # Returns a new Rule object depending on the type of object given.
    #
    # pkg:gem/citrus#lib/citrus.rb:589
    def for(obj); end
  end
end
...
#     expr expr
#
# pkg:gem/citrus#lib/citrus.rb:1194
class Citrus::Sequence
  ...
  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:1198
  def exec(input, events = T.unsafe(nil)); end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:1223
  def to_citrus; end
end
...
#
# pkg:gem/citrus#lib/citrus.rb:944
class Citrus::StringTerminal < ::Citrus::Terminal
  # The +flags+ will be passed directly to Regexp#new.
  #
  # pkg:gem/citrus#lib/citrus.rb:946
  def initialize(rule = T.unsafe(nil), flags = T.unsafe(nil)); end

  # pkg:gem/citrus#lib/citrus.rb:951
  def ==(other); end

  # pkg:gem/citrus#lib/citrus.rb:960
  def eql?(other); end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:963
  def to_citrus; end
end
...
#     super
#
# pkg:gem/citrus#lib/citrus.rb:839
class Citrus::Super
  include ::Citrus::Rule
  include ::Citrus::Proxy
  ...
  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:843
  def to_citrus; end
...
#
# pkg:gem/citrus#lib/citrus.rb:878
class Citrus::Terminal
  include ::Citrus::Rule

  # pkg:gem/citrus#lib/citrus.rb:881
  def initialize(regexp = T.unsafe(nil)); end

  # pkg:gem/citrus#lib/citrus.rb:906
  def ==(other); end

  # Returns +true+ if this rule is case sensitive.
  #
  # pkg:gem/citrus#lib/citrus.rb:902
  def case_sensitive?; end

  # pkg:gem/citrus#lib/citrus.rb:915
  def eql?(other); end

  # Returns an array of events for this rule on the given +input+.
  #
  # pkg:gem/citrus#lib/citrus.rb:889
  def exec(input, events = T.unsafe(nil)); end

  # The actual Regexp object this rule uses to match.
  #
  # pkg:gem/citrus#lib/citrus.rb:886
  def regexp; end

  # Returns +true+ if this rule is a Terminal.
  #
  # pkg:gem/citrus#lib/citrus.rb:918
  def terminal?; end

  # Returns the Citrus notation of this rule as a string.
  #
  # pkg:gem/citrus#lib/citrus.rb:923
  def to_citrus; end
end

# The current version of Citrus as [major, minor, patch].
#
# pkg:gem/citrus#lib/citrus/version.rb:3
