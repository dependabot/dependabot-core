...
class TurboTests::Reporter
  ...
  # source://turbo_tests//lib/turbo_tests/reporter.rb#39
  def add(name, outputs); end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#120
  def error_outside_of_examples(error_message); end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#108
  def example_failed(example); end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#95
  def example_passed(example); end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#101
  ...
  # source://turbo_tests//lib/turbo_tests/reporter.rb#125
  def finish; end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#91
  def group_finished; end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#87
  ...
  # source://turbo_tests//lib/turbo_tests/reporter.rb#115
  ...
  # source://turbo_tests//lib/turbo_tests/reporter.rb#77
  def report_number_of_tests(groups); end

  # source://turbo_tests//lib/turbo_tests/reporter.rb#66
  def start(example_groups, time = T.unsafe(nil)); end

  protected

  # source://turbo_tests//lib/turbo_tests/reporter.rb#160
...
class TurboTests::Runner
  ...
  #
  # source://turbo_tests//lib/turbo_tests/runner.rb#44
  ...
  # source://turbo_tests//lib/turbo_tests/runner.rb#278
  ...
  # source://turbo_tests//lib/turbo_tests/runner.rb#111
  def start_regular_subprocess(tests, process_id, **opts); end

  # source://turbo_tests//lib/turbo_tests/runner.rb#121
