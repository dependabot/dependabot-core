...
class MIME::Type
  ...
  # Returns +true+ if the media type is obsolete.
  #
  # source://mime-types//lib/mime/type.rb#387
  def obsolete?; end
  ...
  # Indicateswhether the MIME type is declared as a signature type.
  #
  # source://mime-types//lib/mime/type.rb#473
  def signature?; end
...
class MIME::Types
  ...
  #
  # source://mime-types//lib/mime/types.rb#160
  def of(filename); end
  ...
  class << self
    ...
    #
    # source://mime-types//lib/mime/types/registry.rb#36
    def of(filename); end
...
class MIME::Types::Container
  ...
  # source://mime-types//lib/mime/types/container.rb#50
