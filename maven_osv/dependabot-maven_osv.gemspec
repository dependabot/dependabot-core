...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-maven_osv"
  spec.summary      = "Provides Dependabot+OSV support for Maven"
  spec.description  = "Dependabot-Maven provides support for bumping Maven packages via Dependabot and OSV. " \
