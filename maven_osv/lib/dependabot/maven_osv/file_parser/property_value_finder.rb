      ...
      class PropertyValueFinder
        ...
        def initialize(dependency_files:, credentials: [])
          ...
          @pom_fetcher = T.let(PomFetcher.new(dependency_files: dependency_files),
                               Dependabot::MavenOSV::FileParser::PomFetcher)
        end
        ...
        def repositories_finder
          @repositories_finder ||= T.let(
            Dependabot::MavenOSV::FileParser::RepositoriesFinder.new(
              pom_fetcher: @pom_fetcher,
              dependency_files: dependency_files,
              credentials: @credentials,
              evaluate_properties: false
            ),
            T.nilable(Dependabot::MavenOSV::FileParser::RepositoriesFinder)
          )
        end
      end
    end
