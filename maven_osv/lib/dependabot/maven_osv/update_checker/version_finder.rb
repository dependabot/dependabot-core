      ...
      class VersionFinder
        ...
        def filter_ignored_versions(possible_versions)
          ...
          ignored_versions.each do |req|
            ignore_requirements = MavenOSV::Requirement.requirements_array(req)
            filtered =
              filtered
        ...
        def repository_finder
          @repository_finder ||=
            MavenOSV::FileParser::RepositoriesFinder.new(
              pom_fetcher: MavenOSV::FileParser::PomFetcher.new(dependency_files: dependency_files),
              dependency_files: dependency_files,
              credentials: credentials
            )
        end
