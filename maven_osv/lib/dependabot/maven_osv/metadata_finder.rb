...
require "dependabot/maven_osv/file_parser/repositories_finder"
require "dependabot/maven_osv/utils/auth_headers_finder"
  ...
  module MavenOSV
    class MetadataFinder < Dependabot::MetadataFinders::Base
      ...
      def repo_has_subdir_for_dep?(tmp_source)
        ...
        fetcher =
          Dependabot::MavenOSV::FileFetcher.new(source: tmp_source, credentials: credentials)
      ...
      def substitute_properties_in_source_url(source_url, pom)
        ...
        regex = MavenOSV::FileParser::PROPERTY_REGEX
      ...
      def maven_repo_url
        ...
        source&.fetch(:url, nil) ||
          source&.fetch("url") ||
          Dependabot::MavenOSV::FileParser::RepositoriesFinder.new(credentials: credentials,
      ...
      def auth_headers
        @auth_headers ||= T.let(
          Dependabot::MavenOSV::Utils::AuthHeadersFinder.new(credentials).auth_headers(maven_repo_url),
...
Dependabot::MetadataFinders
  .register("maven_osv", Dependabot::MavenOSV::MetadataFinder)
