...
RSpec.describe Dependabot::MavenOSV::TokenBucket do
  ...
  describe "#compare_token_pair" do
    let(:tokens) do
      [
        ...
        [1, "a", 1],
        ["a", 1, -1],
        [Dependabot::MavenOSV::VersionParser::ALPHA, Dependabot::MavenOSV::VersionParser::ALPHA, 0],
        [1, Dependabot::MavenOSV::VersionParser::ALPHA, 1],
        ["a", Dependabot::MavenOSV::VersionParser::ALPHA, 1],
        [nil, Dependabot::MavenOSV::VersionParser::ALPHA, 1],
        [Dependabot::MavenOSV::VersionParser::BETA, Dependabot::MavenOSV::VersionParser::ALPHA, 1],
        [Dependabot::MavenOSV::VersionParser::MILESTONE, Dependabot::MavenOSV::VersionParser::BETA, 1],
        [Dependabot::MavenOSV::VersionParser::RC, Dependabot::MavenOSV::VersionParser::MILESTONE, 1],
        [Dependabot::MavenOSV::VersionParser::SNAPSHOT, Dependabot::MavenOSV::VersionParser::RC, 1],
        [Dependabot::MavenOSV::VersionParser::SP, 0, 1],
        ["a", Dependabot::MavenOSV::VersionParser::SP, 1]
      ]
    end
