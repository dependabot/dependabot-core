...
require "dependabot/maven_osv/file_parser/pom_fetcher"

RSpec.describe Dependabot::MavenOSV::FileParser::RepositoriesFinder do
  let(:finder) do
    described_class.new(
  ...
  let(:pom_fetcher) { Dependabot::MavenOSV::FileParser::PomFetcher.new(dependency_files: dependency_files) }
