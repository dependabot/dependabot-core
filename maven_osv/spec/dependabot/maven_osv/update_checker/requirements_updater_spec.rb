...
require "spec_helper"
require "dependabot/maven_osv/update_checker/requirements_updater"

RSpec.describe Dependabot::MavenOSV::UpdateChecker::RequirementsUpdater do
  let(:updater) do
    described_class.new(
  ...
  let(:version_class) { Dependabot::MavenOSV::Version }
