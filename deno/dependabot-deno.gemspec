...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-deno"
  spec.summary      = "Provides Dependabot support for Deno"
  spec.description  = "Dependabot-Deno provides support for bumping Deno dependencies via Dependabot. " \
