...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-luarocks"
  spec.summary      = "Provides Dependabot support for Luarocks"
  spec.description  = "Dependabot-Luarocks provides support for bumping Luarocks dependencies via Dependabot. " \
