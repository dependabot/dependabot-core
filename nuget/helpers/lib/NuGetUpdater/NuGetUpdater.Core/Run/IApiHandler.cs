...
public static class IApiHandlerExtensions
{
    ...
    public static Task CreateDependencySubmission(this IApiHandler handler, DependencySubmissionPayload payload) => handler.PostAsJson("create_dependency_submission", payload);
