...
public partial class DiscoveryWorkerTests : DiscoveryWorkerTestBase
{
    ...
    public async Task TestProjectFiles(string projectPath)
    {
        ...
        {
            // this package ships with the SDK and is automatically added for F# projects
            expectedDependencies.Add(new Dependency("FSharp.Core", "8.0.301", DependencyType.PackageReference, TargetFrameworks: ["net8.0"], IsDirect: true));
        }
