...
RSpec.describe Dependabot::Nuget::FileFetcher do
  ...
  # context "when each project has a projects.config and has multiple refrences to the same project" do
  #   let(:directory) { "/src/a/" }

  #   before do
  #     GitHubHelpers.stub_requests_for_directory(
  #       ->(a, b) { stub_request(a, b) },
  #       File.join(__dir__, "..", "..", "fixtures", "github", "multiple_packages_config_multiple_references"),
  #       "",
  #       url,
  #       "token token",
  #       "gocardless",
