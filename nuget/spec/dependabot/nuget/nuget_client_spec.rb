...
RSpec.describe Dependabot::Nuget::NugetClient do
  describe "#get_package_versions" do
    ...
    context "with package versions from local" do
    ...
    context "with package versions _might_ have the `listed` flag" do
      before do
    ...
    context "with versions can be retrieved from v2 apis" do
      before do
