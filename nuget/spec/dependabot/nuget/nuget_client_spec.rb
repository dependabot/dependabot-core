...
RSpec.describe Dependabot::Nuget::NugetClient do
  describe "#get_package_versions" do
    ...
    context "when retrieving package versions from local" do
    ...
    context "when package versions _might_ have the `listed` flag" do
      before do
    ...
    context "when versions can be retrieved from v2 apis" do
      before do
