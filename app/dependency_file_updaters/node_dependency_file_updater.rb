...
module DependencyFileUpdaters
  class NodeDependencyFileUpdater
    ...
    def initialize(dependency_files:, dependency:)
      ...
      @shrinkwrap = dependency_files.find { |f| f.name == "npm-shrinkwrap.json" }
    ...
    def updated_package_json_content
      ...
      if parsed_content.fetch("dependencies", {})[dependency.name] != nil
        parsed_content["dependencies"][dependency.name] = dependency.version
      end

      if parsed_content.fetch("devDependencies", {})[dependency.name] != nil
    ...
    def updated_shrinkwrap_content
      ...
      SharedHelpers.in_a_temporary_directory do |dir|
        ...
        @updated_shrinkwrap_content = File.read(File.join(dir, "npm-shrinkwrap.json"))
      end
    end
  end
end
