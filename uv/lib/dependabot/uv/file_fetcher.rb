...
module Dependabot
  module Uv
    class FileFetcher < Dependabot::FileFetchers::Base
      ...
      sig { params(filenames: T::Array[String]).returns(T::Boolean) }
      ...
      sig { params(path: T.nilable(String)).returns(T::Array[Dependabot::DependencyFile]) }
      ...
      sig { params(filename: String, base_path: T.nilable(String)).returns(Dependabot::DependencyFile) }
