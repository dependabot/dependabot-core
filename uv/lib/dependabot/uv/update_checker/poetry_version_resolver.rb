  ...
  module Uv
    class UpdateChecker
      ...
      class PoetryVersionResolver
        ...
        sig { returns(Dependabot::Uv::PoetryErrorHandler) }
        ...
        def add_auth_env_vars
          Uv::FileUpdater::PyprojectPreparer
        ...
        def set_target_dependency_req(pyproject_content, updated_requirement)
          ...
          Dependabot::Uv::FileParser::PyprojectFilesParser::POETRY_DEPENDENCY_TYPES.each do |type|
